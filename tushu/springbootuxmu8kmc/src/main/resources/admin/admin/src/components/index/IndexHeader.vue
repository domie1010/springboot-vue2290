<template>
	<div class="navbar">
		<div class="title" :style='{"margin":"0","top":"0","textAlign":"center","left":"20px","background":"none","display":"block","width":"auto","position":"absolute","order":"1"}'>
			...
			<span class="title-name" :style='{"padding":"0 0 0 12px","lineHeight":"50px","fontSize":"18px","color":"#fff","textShadow":"1px 1px 0 rgba(0, 0, 0, 0.2)","fontWeight":"500"}'>{{this.$project.projectName}}</span>
		</div>
		<!--
